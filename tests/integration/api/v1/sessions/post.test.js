...
describe("POST /api/v1/sessions", () => {
  describe("Anonymous user", () => {
    ...
    test("With wrong password but correct email", async () => {
      await orchestrator.createUser({
    ...
    test("With wrong email and password", async () => {
      await orchestrator.createUser({});
    ...
    test("With correct email and password", async () => {
      const createdUser = await orchestrator.createUser({
        email: "email-super-correto@test.com",
        password: "senha-correta",
      });
      ...
      expect(parsedSetCookie.session_id.value).toBe(responseBody.token);
